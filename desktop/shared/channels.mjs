export const DESKTOP_CHANNELS = {
  ...
  COMPUTER_APP: "sentinel:computer-app",
  COMPUTER_APPS: "sentinel:computer-apps",
  COMPUTER_ACTION: "sentinel:computer-action",
  COMPUTER_AX_ACTION: "sentinel:computer-ax-action",
  COMPUTER_AX_FIND: "sentinel:computer-ax-find",
  COMPUTER_AX_TREE: "sentinel:computer-ax-tree",
  COMPUTER_CLIPBOARD: "sentinel:computer-clipboard",
  COMPUTER_SCREENSHOT: "sentinel:computer-screenshot",
  COMPUTER_STATUS: "sentinel:computer-status",

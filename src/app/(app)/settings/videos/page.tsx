...
function VideosSettingsSkeleton() {
  return (
...
export default function VideosSettingsPage() {
  ...
  return (
    <SettingsPageWrapper
      subtitle="Choose default video providers, configure per-provider models, and control which providers can participate in video generation."
      title="Videos"
    >
      {settingsQuery.isPending || providersQuery.isPending ? (
        <VideosSettingsSkeleton />
      ) : (
          ...
          >
            <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
              ...
              <div className="grid w-full gap-3 lg:max-w-xl lg:grid-cols-[minmax(0,1fr)_auto]">
                <ControlledSelectField
                  control={form.control}
                  description="Only providers with active credentials and a valid video target appear here."
            ...
            <section className="overflow-hidden rounded-2xl border border-separator/30 bg-surface">
              <div className="border-separator/20 flex flex-wrap items-center justify-between gap-3 border-b px-4 py-3">
                <div className="space-y-1">
                  ...
                  <p className="text-muted text-xs">
                    Keep each provider lean: enable it, pick its video target,
                    and save.
                  </p>
                </div>

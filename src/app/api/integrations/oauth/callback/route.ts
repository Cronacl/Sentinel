...
function renderIntegrationIcon(provider: IntegrationProvider | null) {
  switch (provider) {
    ...
    case "notion":
      return `
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="12 0.18999999999999906 100 100" aria-hidden="true">
          <path d="M25.56 10.94c4.07 3.18 5.6 2.96 13.27 2.43l72.26-4.36c1.54 0 .26-1.54-.26-1.8L101.62.82c-2.3-1.8-5.38-3.86-11.24-3.44L20.5 2.74c-2.56.26-3.08 1.54-2.04 2.56zm4.34 17.27v75.92c0 4.08 2.04 5.62 6.64 5.36L106.21 105c4.6-.26 5.12-3.08 5.12-6.42v-75.4c0-3.34-1.28-5.12-4.08-4.86L36.54 23.1c-3.06.26-4.64 1.54-4.64 5.1zm73.04 3.34c.52 2.3 0 4.6-2.3 4.86l-3.58.78v56.1c-3.08 1.54-5.9 2.56-8.2 2.56-3.84 0-4.86-1.02-7.68-4.34l-23.52-36.9v35.66l7.42 1.54s0 4.6-6.38 4.6l-17.66 1.04c-.52-1.04 0-3.6 1.78-4.08l4.6-1.28v-47.1l-6.38-.52c-.52-2.3.78-5.6 4.34-5.88l18.96-1.28 24.52 37.44V46.52l-6.12-.52c-.52-2.82 1.54-4.86 4.08-5.12zm-79.7-42.1l71.22-4.6c8.72-.78 10.98-.26 16.36 3.86l22.5 15.92c3.58 2.56 4.86 3.34 4.86 6.16v77.72c0 4.86-1.78 7.68-8.2 8.2L35 90.8c-4.86.26-7.16-.52-9.72-3.86l-15.6-20.26c-2.82-3.86-4.08-6.68-4.08-10.02V-4.92c0-4.08 1.8-7.42 8.44-8.2z" fill-rule="evenodd" fill="#fff"/>
        </svg>`;
    case "github":
      return `

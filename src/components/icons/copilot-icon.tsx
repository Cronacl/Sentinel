...
type CopilotIconProps = SVGProps<SVGSVGElement> & {
  decorative?: boolean;
};
...
export function CopilotIcon({
  ...
  return (
    <svg
      ...
      aria-label={decorative ? undefined : "GitHub Copilot"}
      className={cx("shrink-0 text-neutral-950 dark:text-white", className)}
      fill="none"
      focusable="false"

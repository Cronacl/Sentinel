...
function buildRuntimeSnapshot(
  ...
  return section("Runtime Snapshot", [
    ...
    promptContext.toolTags && promptContext.toolTags.length > 0
      ? `Composer tool tags: ${promptContext.toolTags.join(", ")}. Treat these tool categories as explicitly requested for this turn.`
      : "Composer tool tags: none.",
    categories.length > 0

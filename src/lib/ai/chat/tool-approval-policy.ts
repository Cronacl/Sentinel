...
export const TOOL_APPROVAL_GROUPS: Record<string, ToolApprovalGroup> = {
  ...
  airtable: {
    defaultRequireApproval: true,
    description:
      "Airtable tools for browsing bases, managing tables and fields, and working with records.",
    label: "Airtable",
    provider: "airtable",
    riskSummary:
      "Sentinel can list bases, manage tables and fields, and create, update, or delete records in your Airtable workspace.",
    toolNames: [
      "airtable_list_bases",
      "airtable_list_tables",
      "airtable_get_table",
...
> = {
  ...
  airtable_list_bases: {
    ...
    group: "airtable",
    label: "Airtable list bases",
    riskSummary: "Sentinel can view your Airtable bases.",
  },
  airtable_list_tables: {
    defaultRequireApproval: false,
    description: "List tables in an Airtable base.",
    group: "airtable",
    label: "Airtable list tables",
    riskSummary: "Sentinel can view table schemas in your Airtable bases.",
  },
  airtable_get_table: {
    defaultRequireApproval: false,
    description: "Get detailed schema of an Airtable table.",
    group: "airtable",
    label: "Airtable get table",
    riskSummary: "Sentinel can view fields and views in your Airtable tables.",
  },
  airtable_create_table: {
    defaultRequireApproval: true,
    description: "Create a new table in an Airtable base.",
    group: "airtable",
    label: "Airtable create table",
    riskSummary: "Sentinel can create new tables in your Airtable bases.",
  },
  airtable_create_field: {
    defaultRequireApproval: true,
    description: "Add a new field to an Airtable table.",
    group: "airtable",
    label: "Airtable create field",
    riskSummary: "Sentinel can add fields to your Airtable tables.",
  },
  airtable_update_field: {
    defaultRequireApproval: true,
  ...
  airtable_list_records: {
    defaultRequireApproval: false,
    description: "List and filter records in an Airtable table.",
    group: "airtable",
    label: "Airtable list records",
    riskSummary: "Sentinel can view records in your Airtable tables.",
  },
  airtable_get_record: {
    defaultRequireApproval: false,
  ...
  airtable_create_records: {
    ...
    group: "airtable",
    label: "Airtable create records",
    riskSummary: "Sentinel can create new records in your Airtable tables.",
  },
  airtable_update_records: {
    defaultRequireApproval: true,
    description: "Update existing records in an Airtable table.",
    group: "airtable",
    label: "Airtable update records",
    riskSummary: "Sentinel can modify records in your Airtable tables.",
  },
  airtable_delete_records: {
    defaultRequireApproval: true,
  ...
  airtable_list_comments: {
    ...
    group: "airtable",
    label: "Airtable list comments",
    riskSummary: "Sentinel can view comments on your Airtable records.",
  },
  airtable_create_comment: {
    defaultRequireApproval: true,
    description: "Add a comment to an Airtable record.",
    group: "airtable",
    label: "Airtable create comment",
    riskSummary: "Sentinel can post comments on your Airtable records.",
  },
  airtable_get_user: {
    defaultRequireApproval: false,
    description: "Get the current Airtable user's identity.",
    group: "airtable",
    label: "Airtable get user",
    riskSummary: "Sentinel can view your Airtable user identity and email.",
  },
};
